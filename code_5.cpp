...
PIMAGE pao, gameover;
PIMAGE background2, background3;
...
void data_withoutinput()  ///没有数据输入时
{
    ...
    {
        if((food3.position_x + 40/*三号鱼尺寸一半*/ >= players.position_x ) && (food3.position_x + 40 <= players.position_x + p1size)
                && (food3.position_y + 35 >= players.position_y )  && (food3.position_y + 35 <= players.position_y + p1size))
        {
            mciSendString(TEXT("open backmusic\\2.mp3"), NULL, 0, NULL);                  ///关闭被吃音效
            mciSendString(TEXT("stop backmusic\\bit.mp3"), NULL, 0, NULL);                 ///暂停吃的音效
            mciSendString(TEXT("close backmusic\\bit.mp3"), NULL, 0, NULL);               ///关闭吃的音效
        ...
        if((food7.position_x + 80/2.0 /*七号海马鱼尺寸一半*/>= players.position_x) && (food7.position_x + 80/2.0 <= players.position_x + p1size)
                && (food7.position_y + 20 >= players.position_y) && (food7.position_y + 70/2.0 <= players.position_y + p1size))
        {
            mciSendString(TEXT("open backmusic\\2.mp3"), NULL, 0, NULL);                ///关闭被吃音效
            mciSendString(TEXT("stop backmusic\\bit.mp3"), NULL, 0, NULL);              ///暂停吃的音效
            mciSendString(TEXT("close backmusic\\bit.mp3"), NULL, 0, NULL);             ///关闭吃的音效
